...
//         {/* Links Section: Technical Events, Non-Technical Events, Reach Us */}
//         <div className="grid grid-cols-1 sm:grid-cols-3 gap-10 text-center text-sm lg:w-1/3">
//           {/* Technical Events */}
//           <div>
//             <h3 className="text-center glitch tracking-wide text-[#57cfdc]">
//               Technical <span className="text-[#FF4500]">Events</span>
//             </h3>
//             <ul className="mt-2 space-y-1">
//               <li><a className="text-white" href="#">Features</a></li>
//               <li><a className="text-white" href="#">Integrations</a></li>
...
//           <div>
//             <h3 className="text-center glitch tracking-wide text-[#57cfdc]">
//               Non-Technical <span className="text-[#FF4500]">Events</span>
//             </h3>
//             <ul className="mt-2 space-y-1">
...
//           {/* Reach Us */}
//           <div>
//             <h3 className="glitch tracking-wide text-[#57cfdc]">
...
//       </div>
//       <div className="mt-9 glitch tracking-wide text-center text-white text-sm">
//         <p>COPYRIGHT &copy;  CEBROID'24</p>
//         <p>Developed by the CEBROID Web Development Crew</p>
//       </div>
//     </footer>
//   );
// };
